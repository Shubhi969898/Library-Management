...
public class MainController {
	...
	public String init(@RequestParam long id,HttpServletRequest req) {
		req.setAttribute("book", lmsService.findOne1(id));
	...
	public void deleteBook(@RequestParam Book book,HttpServletRequest req,HttpServletResponse resp)throws IOException{
		lmsService.delete(book);
